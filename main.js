...
if(e.shiftKey == true && keyPressed == '80')//qdo pressiona shift + P aumenta o bloco
{
	console.log("p e shift pressionadas juntas");
	blockImageWidth = blockImageWidth + 10;
	blockImageHeight = blockImageHeight + 10;
	document.getElementById("currentWidth").innerHTML = blockImageWidth;//mostrar a altura e largura no html
